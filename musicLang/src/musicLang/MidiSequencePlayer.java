...
public class MidiSequencePlayer {
    ...
    public static final int DEFAULT_BEATS_PER_MINUTE = 120;	//default tempo
    public static final int DEFAULT_TICKS_PER_BEAT = 64;	//default ticks per beat
    private static final int DEFAULT_VELOCITY = 100;	//default velocity
    private static final int META_MARKER = 6;	// generic marker meta message type
    ...
    private final Map<MusicInstrument, Integer> channels = new HashMap<MusicInstrument, Integer>();
     ...
     */
    public void addNote(MusicInstrument instr, Pitch pitch, double startBeat, double numBeats) {
     ...
     */
    private int getChannel(MusicInstrument instr) {
    ...
    private void patchInstrumentIntoChannel(int channel, MusicInstrument instr) {
        try {
